...
const About = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between items-start p-8 space-y-20 md:px-10 md:py-12 md:space-x-20 lg:px-56 lg:py-10 lg:space-x-52 lg:space-y-0">
