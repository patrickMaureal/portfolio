...
const Contact = () => {
	return (
		<div className="flex flex-col md:flex-row justify-between items-start p-8 md:px-20 md:py-12 md:space-x-20 md:space-y-0 lg:px-28 lg:py-10 space-y-16 lg:space-x-28 lg:space-y-0">
